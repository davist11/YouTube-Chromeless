 ...
 * @version 0.2
 */
(function(d){d.fn.ytchromeless=function(){var p={videoWidth:"640",videoHeight:"360",videoIdBase:"ytplayer",params:{allowScriptAccess:"always",wmode:"transparent"}};return this.each(function(q){var e=d.extend(p,e),g=d(this),r=g.attr("href"),f=g.attr("id")||e.videoIdBase+q,s=r.substr(31),a=g.wrap('<div class="video-player"></div>').parent(),h=d('<div class="video-controls"></div>').appendTo(a);d('<div class="video"></div>').prependTo(a).attr("id",f);var m,n,o,i,j,k,b;a.bind({togglePlay:function(){a.togglePlay()},
play:function(){a.play()},pause:function(){a.pause()},toggleMute:function(){a.toggleMute()},mute:function(){a.mute()},unMute:function(){a.unMute()},seek:function(){a.seek()},update:function(){a.update()},cue:function(){b.cueVideoById(s)}});a.togglePlay=function(){j.hasClass("playing")?a.trigger("pause"):a.trigger("play");return false};a.play=function(){b.playVideo();j.removeClass("paused").addClass("playing").attr("title","Pause")};a.pause=function(){b.pauseVideo();j.removeClass("playing").addClass("paused").attr("title",
...
100;o.css("width",c+"%")}if(b.getCurrentTime()>0){c=b.getCurrentTime()/b.getDuration()*100;n.css("left",c+"%")}}};onYouTubePlayerReady=function(c){var l=d(document.getElementById(c)).parent();setInterval(function(){l.trigger("update")},250);l.trigger("cue")};a.init=function(){swfobject.embedSWF("http://www.youtube.com/apiplayer?&enablejsapi=1&playerapiid="+f,f,e.videoWidth,e.videoHeight,"8",null,null,e.params,{id:f},function(){b=document.getElementById(f)});a.addControls()};a.addControls=function(){j=
